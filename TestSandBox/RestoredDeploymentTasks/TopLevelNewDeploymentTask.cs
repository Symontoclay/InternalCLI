...
namespace TestSandBox.RestoredDeploymentTasks
{
    public class TopLevelNewDeploymentTask: NewBaseDeploymentTask
    {
        ...
        protected override void OnRun()
        {
            ...
            Exec(new TopSubItemNewDeploymentTask(new TopSubItemNewDeploymentTaskOptions(), "FCD75A10-189C-4F44-815E-0FD6F8AB9A93", _context, this));//"143DEB1D-97E5-44B0-B1FF-5CA85A6A0818"
