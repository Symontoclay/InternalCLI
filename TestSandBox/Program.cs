...
namespace TestSandBox
{
    class Program
    {
        ...
        private static void TstMakeReleaseCommandLineParserHandler()
        {
            ...
            var handler = new TstMakeReleaseCommandLineParserHandler();
            handler.Run();
        ...
        private static void TstUpdateInstalledNuGetPackageInAllCSharpProjectsCommandLineParserHandler()
        {
            ...
            var handler = new TstUpdateInstalledNuGetPackageInAllCSharpProjectsCommandLineParserHandler();
            handler.Run();
        ...
        private static void TstRestoredDeploymentTasks()
        {
            ...
            var handler = new RestoredDeploymentTasksHandler();
            handler.Run();
        ...
        private static void TstTestDeploymentTask()
        {
            ...
            //deploymentPipeline.Add(new CreateAndPushVersionBranchInTestRepositoriesTask());
