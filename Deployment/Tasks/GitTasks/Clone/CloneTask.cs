...
namespace Deployment.Tasks.GitTasks.Clone
{
    public class CloneTask : BaseDeploymentTask
    {
        ...
        private readonly CloneTaskOptions _options;

        /// <inheritdoc/>
        protected override void OnValidateOptions()
        {
            ValidateOptionsAsNonNull(_options);
            ValidateStringValueAsNonNullOrEmpty(nameof(_options.RepositoryHref), _options.RepositoryHref);
        ...
        protected override void OnRun()
        {
            ...
            var gitProcess = new GitProcessSyncWrapper($"clone \"{_options.RepositoryHref}\"");
        ...
        protected override string PropertiesToString(uint n)
        {
            ...
            sb.AppendLine($"{spaces}Clones repository '{_options.RepositoryHref}' to path '{_options.RepositoryPath}'.");
